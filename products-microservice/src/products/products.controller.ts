...
import { CreateProductDto } from '@common/productsService/dto/create-product.dto';
import { Product } from '@common/productsService/entities/product.entity';
...
import { AdminGuard } from '../../../libs/src/guards/admin.guard';
import { CapitalizeNamePipe } from '../../../libs/src/pipes/capitalize-name.pipe';
import { TransformResponseInterceptor } from '../../../libs/src/interceptors/transform-response.interceptor';
import {
  ApiOperation,
  ApiResponse,
  ApiTags,
} from '@nestjs/swagger';
import { RolesGuard } from '../../../libs/src/authService/guards/roles.guard';
import { UserRole } from '../../../libs/src/usersService/entities/user.enum';
import { Roles } from '../../../libs/src/authService/decorator/roles.decorator';
